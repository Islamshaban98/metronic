...
export const Insert = (data) => {
    ...
    getData.push(data)
   localStorage.setItem(KEYS.section_1_data,JSON.stringify(getData))
}
...
export const getAllData=()=>{
    if(localStorage.getItem(KEYS.section_1_data)==null)
    localStorage.setItem(KEYS.section_1_data,JSON.stringify([]))
return JSON.parse(localStorage.getItem(KEYS.section_1_data))
}
