...
import * as SectionService from "./SectionServices";
...
import { useStyels } from "./Section1.style";
...
const Section1Form = () => {
  ...
  const headCells = [
    ...
    { id: "btn-1", lable: "Button 1" },
    { id: "btn-2", lable: "Button 2" },
    { id: "img", lable: "Image" },
  ...
  return (
    <>
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={record.id}>
                ...
                <TableCell className={classes.txtContainer}>{record.btn_1}</TableCell>
                <TableCell className={classes.txtContainer}>{record.btn_2}</TableCell>
      ...
      />
      <PopUp openPopup={openPopup} setOpenPopup={setOpenPopup} title="Section One Form">
