import {
  ...
  import { useStyels } from "./Section4.style";
  ...
  const Section4Form = () => {
    ...
    return (
            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow key={record.id}>
                  ...
                  <TableCell className={classes.txtContainer}><div dangerouslySetInnerHTML={{ __html: record.parag }}></div></TableCell>
                  <TableCell>
      ...
      <CKEditor  data={values.parag} onChange={onEditorChange} name="myEditor"/>
          </Grid>
          <Grid xs={12}>
